...
# This builds an akanda appliance VM image at $SRC_ROOT/build/akanda.qcow2,
# containing the akanda-appliance code as it is currently checked out
# in this local repository.

SRC_ROOT="$(dirname $0)/.."
IMG_OUT=$SRC_ROOT/build/akanda
